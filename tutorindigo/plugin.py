    ...
    hooks.Filters.ENV_PATCHES.add_items(
        [
            (
                ...
                """
RUN npm install '@edx/frontend-component-header@npm:@edx/frontend-component-header-edx@latest' '@edx/brand@git+https://github.com/edly-io/brand-openedx.git#indigo-2.5.1'
""",  # noqa: E501
            ),
        ]
    )
